spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red> WELECOM TO BANANA HUB<Color=/>"):Display()
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>SCRIPT BY FAN<Color=/>"):Display()
end)
----------------------------------------------------------------------------------------------------------------------------------------------
...
ImageButton.Position = UDim2.new(0.101969875, 0, 0.110441767, 0)
ImageButton.Size = UDim2.new(0, 64, 0, 42)
ImageButton.Image = "rbxassetid://16185708397"
 ...
 AutoW:OnChanged(function(Value)
  ...
  spawn(function()
	...
	spawn(function()
           ...
           local ToggleYama = Tabs.Main:AddToggle("ToggleYama", {Title = "Auto Get Yama[Sea3]", Default = false })
        ...
        local ToggleTushita = Tabs.Main:AddToggle("ToggleTushita", {Title = "Auto Tushita[Sea3]", Default = false })
